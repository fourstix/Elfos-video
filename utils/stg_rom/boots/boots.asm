...
SYSINI:	DIS			; disable interrupts ...
	.DB	$00		; ... and set X=P=0
	OUT	4		; display a POST code
	.DB	$99		; POST code 99 - the CPU is alive!
...
COMND1:	RCOPY(P1,P3)	; reset the command line pointer
	LDN	P2	; get the minimum match count for the next command
	INC	P2	; ...
...
COMND2:	LDX		; take a peek at the next command table byte
...
; This command doesn't match.  Skip it and move on to the next...
	IRX\ IRX	; skip two bytes for the dispatch address
